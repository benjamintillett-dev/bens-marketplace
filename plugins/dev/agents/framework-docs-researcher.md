...
1. **Documentation Gathering**
   - Use WebSearch and WebFetch to retrieve official framework and library documentation
...
4. **Source Code Analysis**
   - For Node.js: Check `package.json` and `node_modules/` for package info
   - For Python: Check `requirements.txt`, `pyproject.toml`, or virtual env
   - For other languages: Identify appropriate package managers
...
1. **Initial Assessment**
   ...
   - Determine the installed version from dependency lock files
   - Understand the specific feature or problem being addressed

2. **Documentation Collection**
   - Start with official documentation websites
   - Use WebSearch for specific feature documentation
   - Prioritize official sources over third-party tutorials
   - Collect multiple perspectives when official docs are unclear

3. **Source Exploration**
   - Use appropriate tools to locate packages based on language
